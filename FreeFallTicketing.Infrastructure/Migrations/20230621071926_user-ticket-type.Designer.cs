...
namespace SkyDiveTicketing.Infrastructure.Migrations
{
    ...
    [Migration("20230621071926_user-ticket-type")]
    partial class usertickettype
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SkyDiveTicketing.Core.Entities.ShoppingCartTicket", b =>
                {
            ...
            modelBuilder.Entity("SkyDiveTicketing.Core.Entities.ShoppingCartTicket", b =>
                {
                    b.HasOne("SkyDiveTicketing.Core.Entities.ShoppingCart", "ShoppingCart")
                        .WithMany("ShoppingCartTickets")
                        .HasForeignKey("ShoppingCartId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SkyDiveTicketing.Core.Entities.Ticket", "Ticket")
                        .WithMany("ShoppingCartTickets")
